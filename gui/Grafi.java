   ...
   */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals(" E X I T ")) {
			...
			FileDialog fd = new FileDialog(f1, "load genome file",
					FileDialog.LOAD);
			fd.setVisible(true);
			...
			FileDialog fd = new FileDialog(f1, "load a population in listbox ",
					FileDialog.LOAD);
			fd.setVisible(true);
			...
			FileDialog fd = new FileDialog(f1,
					"load all genome winner in population ", FileDialog.LOAD);
			fd.setVisible(true);
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if ((ckx.equalsIgnoreCase("link with 'width'"))
				|| (ckx.equalsIgnoreCase("link normal"))) {
