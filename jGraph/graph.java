...
public class graph extends javax.swing.JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("Function")) {
			...
			v1.add(new code(10, 710, " >> random generator example of string ",
					3, CodeConstant.DESCRIPTOR_CURVE));

			for (int j = 0; j < 20; j++) {
				double y2 = NeatRoutine.randint(300);
				double x2 = j * 2;
				v1.add(new code((int) x1, (int) y1, (int) x2, (int) y2,
		...
		if (e.getActionCommand().equals("Cartesio")) {
			...
			while (itr_edge.hasNext()) {
				...
				if ((_inode.x) != 0 && (_inode.y != 0) && (_onode.x) != 0
					...
					v1.add(new code(_inode, _onode, type, segno_weight,
							weight_edge));
