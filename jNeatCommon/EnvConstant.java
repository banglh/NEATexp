...
/**
 * Insert the type's description here. Creation date: (21/03/2002 13.55.19)
 * 
...
public class EnvConstant {
	...
	public static double MIN_ERROR = 0.0; // public static double MAX_ERROR =
											// 0.0;
	...
	public static String CURRENT_POPULATION_VIEW = "xxx"; // 01.06.2002 : first
															// organism winner
	...
	public static final String NEAT_TODAI_NAME = "NEAT_TODAI";
	public static final String SPECIES_NEAT_NAME = "SPECIES_NEAT";
	public static final String TOPOLOGY_NEAT_NAME = "TOPOLOGY_NEAT";
