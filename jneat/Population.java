...
int maxsize=0;
  ...
  Organism selectorganism=null;
	  ...
	  sum=0;
          max=0.0;
	  	//System.out.println(generation+"世代");
	  	 itr_specie = species.iterator();
       ...
       while (itr_specie.hasNext())
         ...
         // System.out.println(generation+"世代選ばれた代表個体は、種id:"+selectorganism.species.getId()+"適応度は"+selectorganism.fitness);
          double maxdist = 0.0;
                 maxdist=0.0;
                  itr_specie = species.iterator();
	   ...
	   while (itr_specie.hasNext())
		 {
          ...
          // System.out.println("マックス距離は"+maxdist);
