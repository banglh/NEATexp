/* Generated by Together */
   ...
   */
      public double compute_disjoint(Organism kizyun)
     {
         ...
         //System.out.println("éÌ"+kizyun.getSpecies().id+"Ç∆éÌ"+id+"ÇÃDisjointílÇÕ"+disjoint);
         return disjoint;
																	...
																	public double compute_excess(Organism kizyun)
     {
         ...
         //System.out.println("éÌ"+kizyun.getSpecies().id+"Ç∆éÌ"+id+"ÇÃExcessílÇÕ"+excess);
         return excess;
   ...
   */
	  ...
	  double seikika=0.0;
		 ...
		 //Share fitness with the species
                        ...
                        //System.out.println("ÉTÉCÉYÇÕ"+maxsize);
		 	...
		 	if(seikika==1)
                    ...
                    _organism.fitness = _organism.fitness *  ((double)maxsize*(1-seikika));
   ...
   */
		 ...
		 {
			_organism = (Organism) organisms.elementAt(j);
		 	//System.out.println("éÌ"+id+"ï]âøÇÕ"+_organism.fitness);
	 ...
	 Iterator itr_organism;
	  ...
	  double fitness=0;
		...
		if(_organism.fitness>fitness)
                {
                    fitness=_organism.fitness;
                    max = fitness;
                }
                }
		 
//System.out.println("éÌid:"+this.id+"ç≈çÇìKâûìxÇÕ"+max);
                 return max;
           ...
           public double maxdistance(double max,Organism selectorganism)
    {
        ...
        int j=0;
         ...
         for (j=0; j < size1; j++)
		 {
			_organism = (Organism) organisms.elementAt(j); 
                         double curr_compat = _organism.getGenome().compatibility(selectorganism.getGenome());
		 	 //System.out.println("éÌ"+id+"Ç∆å¬ëÃÇÃãóó£ÇÕ"+curr_compat);
                         if(curr_compat>max)
                         {
                             max = curr_compat;
                         }
	   ...
	   public void compute_average_fitness() 
	  {
		 ...
		 double total = 0.0;
		 int size1 = organisms.size();
	   //System.out.println("éÌid:"+this.id);
		 while (itr_organism.hasNext()) 
		 {
			Organism _organism = ((Organism) itr_organism.next());
   ...
   */          
                                                                                                                                ...
                                                                                                                                public void print_to_file2(IOseq xFile,int speciesize) 
	  {
           ...
           int size1 = organisms.size();
                 int sizenumber=0; //0:ëÂãKñÕ1:íÜãKñÕ2:è¨ãKñÕ
                       StringBuffer s2 = new StringBuffer();
                       s2.append(id);
                       s2.append(",");
