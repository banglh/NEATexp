...
public class jConsoleNeat {
	...
	public static void main(java.lang.String[] args) {
		...
		/*
		 * // // -------------- testing a depth, stability , for the following
		 * genome --------------- // nomeA = "c:\\jneat\\dati\\genome.ex2"; //
		 * depth must be = 3 Evolution.Experiment2(nomeA);
		 * 
		 ...
		 * genome-------------------------- // nomeA =
		 * "c:\\jneat\\dati\\genome.old"; Evolution.Experiment1(nomeA,10);
		 */
		...
		/*
		 * // // -------------------- compare and mate for two genome // nomeA =
		 * "c:\\jneat\\dati\\genome.ex7"; nomeB = "c:\\jneat\\dati\\genome.ex8";
		 * Evolution.Experiment4(nomeA,nomeB);
		 * 
		 * nomeA = "c:\\jneat\\dati\\genome.ex9"; nomeB =
		 * "c:\\jneat\\dati\\genome.ex10"; Evolution.Experiment4(nomeA,nomeB);
		 */

		/*
		 * // // ------ testing if exist recurrent connection from two nodes in
		 * a genome passed ------------- // //
		 * 
